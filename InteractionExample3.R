...
interaction.results.c0<-InteractionCounterData(p,datadir,distance.for.interaction.mm,tracking.region = "C_0")
...
interaction.results.c1<-InteractionCounterData(p,datadir,distance.for.interaction.mm,tracking.region = "C_1")
...
interaction.results.c2<-InteractionCounterData(p,datadir,distance.for.interaction.mm,tracking.region = "C_2")
...
interaction.results.c3<-InteractionCounterData(p,datadir,distance.for.interaction.mm,tracking.region = "C_3")
...
interaction.results.c4<-InteractionCounterData(p,datadir,distance.for.interaction.mm,tracking.region = "C_4")
...
interaction.results.c5<-InteractionCounterData(p,datadir,distance.for.interaction.mm,tracking.region = "C_5")
...
interaction.results.c6<-InteractionCounterData(p,datadir,distance.for.interaction.mm,tracking.region = "C_6")
